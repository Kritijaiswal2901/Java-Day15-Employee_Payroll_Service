...
update employee_payroll set gender = "M" where emp_id in (1, 3, 4);
update employee_payroll set gender = "F" where emp_id = 2;
select * from employee_payroll;

-- output to above queries
-- 1	Bill	10000	2022-10-11	M
-- 2	Alice	20000	2023-05-09	F
-- 3	Charlie	35000	2023-01-01	M
-- 4	Dave	25000	2023-11-01	M

-- UC7
-- getting sum of salaries for M employees
...
-- 1	Bill	10000	2022-10-11	M	91 9456713547	block-201	Development
-- 2	Alice	20000	2023-05-09	F	91 9456712345	block-304	Sales
-- 3	Charlie	35000	2023-01-01	M	91 9456123475	block-503	Marketing
-- 4	Dave	25000	2023-11-01	M	91 9456785612	block-204	Development
...
-- output to above query
-- 1	Bill	10000	2022-10-11	M	91 9456713547	block-201	Development		2000	1000	200		8000
-- 2	Alice	20000	2023-05-09	F	91 9456712345	block-304	Sales			3000	1500	500		17000
-- 3	Charlie	35000	2023-01-01	M	91 9456123475	block-503	Marketing		5000	3000	1000	30000
-- 4	Dave	25000	2023-11-01	M	91 9456785612	block-204	Development		3000	1500	500		22000
...
insert into employee_payroll(name, salary, start_date, gender, phone, address, department, deductions, taxable_pay, income_tax, net_pay) values
 ("Terissa", 40000, "2023-12-08", "F", "91 9456314785", "block-405", "Sales", 5000, 3000, 1000, 35000),
 ("Terissa", 40000, "2023-12-08", "F", "91 9456314785", "block-405", "Marketing", 5000, 3000, 1000, 35000);
select * from employee_payroll;
...
-- 3	Charlie	35000	2023-01-01	M	91 9456123475	block-503	Marketing	5000	3000	1000	30000
-- 4	Dave	25000	2023-11-01	M	91 9456785612	block-204	Development	3000	1500	500		22000
-- 5	Terissa	40000	2023-12-08	F	91 9456314785	block-405	Sales		5000	3000	1000	35000
-- 6	Terissa	40000	2023-12-08	F	91 9456314785	block-405	Marketing	5000	3000	1000	35000
...
insert into employee_payroll(name, salary, start_date, gender, phone, address, deductions, taxable_pay, income_tax, net_pay) values 
	("Terissa", 40000, "2023-12-08", "F", "91 9456314785", "block-405", 5000, 3000, 1000, 35000);
select * from employee_payroll;
desc employee_payroll;

-- output to the above query
-- 1	Bill	10000	2022-10-11	M	91 9456713547	block-201	2000	1000	200		8000
-- 2	Alice	20000	2023-05-09	F	91 9456712345	block-304	3000	1500	500		17000
-- 3	Charlie	35000	2023-01-01	M	91 9456123475	block-503	5000	3000	1000	30000
-- 4	Dave	25000	2023-11-01	M	91 9456785612	block-204	3000	1500	500		22000
-- 7	Terissa	40000	2023-12-08	F	91 9456314785	block-405	5000	3000	1000	35000
...
-- output to the above query
-- 1	Bill	10000	2022-10-11	M	91 9456713547	block-201	2000	1000	200		8000	Development
-- 2	Alice	20000	2023-05-09	F	91 9456712345	block-304	3000	1500	500		17000	Sales
-- 3	Charlie	35000	2023-01-01	M	91 9456123475	block-503	5000	3000	1000	30000	Marketing
-- 4	Dave	25000	2023-11-01	M	91 9456785612	block-204	3000	1500	500		22000	Development
-- 7	Terissa	40000	2023-12-08	F	91 9456314785	block-405	5000	3000	1000	35000	Sales
-- 7	Terissa	40000	2023-12-08	F	91 9456314785	block-405	5000	3000	1000	35000	Marketing
...
-- getting sum, min and max of salaries for M employees
select sum(salary), min(salary), max(salary) from employee_payroll where gender = "M" group by gender;

-- output to above query
-- 70000	10000	35000

-- getting average salary for M and F employees
select gender, avg(salary) from employee_payroll group by gender;
...
-- getting number of M and F employees
select gender, count(gender) from employee_payroll group by gender;
